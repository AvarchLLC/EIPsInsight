...
//   return (
//     <Card className="my-6 border bg-muted text-muted-foreground rounded-2xl shadow-sm">
//       <CardHeader className="flex flex-row justify-between items-center cursor-pointer" onClick={toggleExpand}>
...
//           <CardContent>
//             {loading ? (
//               <p className="text-sm italic text-muted">Generating summary...</p>
//             ) : (
