    ...
    return (
        <>
            ...
            >
                ...
                <Text fontSize="xl" fontWeight="bold" color="#30A0E0" paddingTop={'8'}>
                    Stagnant - [ {data.filter((item) => item.status === 'Stagnant').length} ]
                </Text>
                ...
                <Text fontSize="xl" fontWeight="bold" color="#30A0E0" paddingTop={'8'}>
                    Last Call - [ {data.filter((item) => item.status === 'Last Call').length} ]
                </Text>
                ...
                <Text fontSize="xl" fontWeight="bold" color="#30A0E0" paddingTop={'8'}>
                    Withdrawn - [ {data.filter((item) => item.status === 'Withdrawn').length} ]
                </Text>
