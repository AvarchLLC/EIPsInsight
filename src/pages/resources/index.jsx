...
import imageFive from '../../../public/5.png'
import imageSix from '../../../public/6.png'
        ...
        <AllLayout>
            <div className="ml-40 mr-40 pl-10 pr-10 mt-10 mb-40">
                ...
                <div className='flex justify-between'>
                    ...
                    <Link className='px-4 py-2 border-2 border-green-500 bg-none' href='/'>Contact US</Link>
                </div>
                {/* adding slider  */}
                    ...
                    <div className='bg-[#F3F3F3] w-full md:w-full lg:w-2/5'>
                        ...
                        <div className='flex flex-col gap-3'>
                            <div className='flex gap-3 mx-3'>
                                ...
                                <Link className='flex justify-center items-center' href="https://www.youtube.com/watch?v=sIr6XX8yR8o&list=PLZmWIkdMcWY6sdsjqgQQCcnDqw8lE0WWE&index=1&ab_channel=EtherWorld"> EIPs & Standardization Process
                                </Link>
                            </div>
                            <div className='flex gap-3 mx-3'>
                                <Image className='h-10 w-20' src={imageTwo} alt="." />
                                <Link className='flex justify-center items-center' href="https://www.youtube.com/watch?v=dEgBVAzY6Eg&list=PLZmWIkdMcWY6sdsjqgQQCcnDqw8lE0WWE&index=2&ab_channel=EtherWorld"> Sign-In with Ethereum
                                </Link>
                            </div>
                            <div className='flex gap-3 mx-3'>
                                <Image className='h-10 w-20' src={imageThree} alt="." />
                                <Link className='flex justify-center items-center' href="https://www.youtube.com/watch?v=pO8fmZd4Mjw&list=PLZmWIkdMcWY6sdsjqgQQCcnDqw8lE0WWE&index=3&ab_channel=EtherWorld"> Non-Fungible Token Standard
                                </Link>
                            </div>
                            <div className='flex gap-3 mx-3'>
                                <Image className='h-10 w-20' src={imageFour} alt="." />
                                <Link className='flex justify-center items-center text-sky-700' href="https://www.youtube.com/watch?v=V75TPvK-K_s&list=PLZmWIkdMcWY6sdsjqgQQCcnDqw8lE0WWE&index=4&ab_channel=EtherWorld"> Fractional NFTs
                                </Link>
                            </div>
                            <div className='flex gap-3 mx-3'>
